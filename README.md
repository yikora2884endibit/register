...
3. Make sure your desired subdomain is not in the reserved list. Reserved subdomains include system names like 'www', 'api', 'admin', etc. Check the complete list in `utils/reserved-subdomains.json`.
...
5. Your pull request will be reviewed and merged. Please don't ignore the pull request checklist. If you ignore the checklist, your pull request will be ignored too. _Make sure to keep an eye on it in case we need you to make any changes!_
6. After the pull request is merged, please allow up to 24 hours for the changes to propagate _(usually, it takes 5..15 minutes)_
